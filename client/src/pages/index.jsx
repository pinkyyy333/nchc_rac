    ...
    <>
      ...
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .plan-intro { white-space:pre-wrap; font-size:14px; }
...
{`一、目的：提升財團法人國家實驗研究院國家高速網路與計算中心(以下簡稱國網中心)高效能計算資源之運用成效，落實資源合理分配，協助學研用戶擴大計算規模與能量，增進研發成果之國際競爭力。
二、適用範圍：
(一) 本機制審查對象，為申請國家科學及技術委員會(以下簡稱國科會)補助之專題研究計畫。
(二) 本機制所分配之計算資源，為國網中心台灣杉三號之 CPU 計算時數，不包含台灣杉二號、TWCC 等 GPU 計算時數及其他儲存服務。
(三) 經審查及國科會核定通過之專題研究計畫，可於計畫執行期間內以一般資源費率使用高優先資源，不須額外負擔價差。
(四) 高優先資源係指在國網中心可隨需即算、不需等待的計算資源。
三、審查方式：
(一) 由國科會各學門推薦專家與國網中心共同組成「高效能計算資源審查委員會」進行審查。
(二) 審查委員依據申請計畫所提計算資源需求之必要性、使用規劃與可行性、效率評估等項目，給予計算資源核給建議，供國科會參考。
四、申請方式：
(一) 請國科會專題研究計畫申請書之基本資料中，勾選申請「高效能計算資源」。
(二) 於專題研究計畫申請期限內，填寫「高效能計算資源使用申請表」，於國網中心「高效能計算資源審查網」提出申請(https://rac.nchc.org.tw)。
五、相關資訊及聯絡窗口：
(一) 申請相關說明，請參見國網中心「高效能計算資源審查網」(https://rac.nchc.org.tw)。
(二) 如有疑義，請洽國網中心，電話：03-5776085 分機 262，電子信箱：rac@narlabs.org.tw。
`}
        </div>
      </div>
